...
function showTodo(filter) {
      ...
      if (filter == todo.status || filter == "all") {
        ...
        liTag += `<li class="task">
                            ...
                            <div class="settings">
                                ...
                                <ul class="task-menu">
                                    <li class="addeventatc" data-intel="true" data-styling="none" data-direct="apple" onclick='calTask(${id}, "${
          todo.name
        }")'><i class="uil uil-calender"></i>Lịch
          ...
          todo.name
        }")'><i class="uil uil-pen"></i>Sửa</li>
                                    <li onclick='deleteTask(${id}, "${filter}")'><i class="uil uil-trash"></i>Xóa</li>
                                </ul>
                            </div>
                        </li>`;
      }
  ...
  taskBox.innerHTML = liTag || `<span>Chưa có cần nhớ</span>`;
...
function calTask(taskId, textName) {
